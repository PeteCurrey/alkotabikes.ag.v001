      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8 lg:pt-4">
            ...
            {/* CTA — Add to Cart OR Catalogue Mode gate */}
            <div className="space-y-3">
              {cartEnabled ? (
                // TRANSACTIONAL MODE: real cart interaction
                <button
                  ...
                  className={`w-full inline-flex items-center justify-center gap-2 py-4 font-mono font-semibold text-xs tracking-wider uppercase transition-all duration-200 ${
                    added
                      ...
                      : isComingSoon
                      ? "bg-alkota-slate/20 text-alkota-slate cursor-not-allowed"
                ...
                // CATALOGUE MODE: browse-only — no commerce
                <div className="w-full py-4 px-4 bg-alkota-snow border border-alkota-black/10 font-mono text-[10px] tracking-wide text-alkota-slate text-center space-y-1">
                  <div className="font-bold text-alkota-black uppercase tracking-widest text-[11px]">CATALOGUE MODE</div>
                  <div>Online purchasing opens at product launch.</div>
                  <div>Register for early access at <Link href="/order" className="underline hover:text-alkota-black">alkotacycles.com/order</Link></div>
                </div>
              )}

              {isComingSoon && cartEnabled && (
