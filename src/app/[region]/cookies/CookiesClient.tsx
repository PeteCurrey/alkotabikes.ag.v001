  ...
  return (
    <LegalPageLayout document={doc} toc={TOC} eyebrow="COOKIE & PRIVACY TECHNOLOGY POLICY">
      <div className="space-y-10">
        ...
        <section id="ck-8" className="space-y-4">
          <h2 className="font-display font-bold text-xl uppercase tracking-tight text-alkota-black border-b border-black/10 pb-2">
            08. THIRD-PARTY TECHNOLOGY &amp; PROCESSOR REGISTER
          </h2>
          <p className="text-xs text-alkota-slate">
            The table below lists the active client-side cookies and third-party data processors utilised across alkotacycles.com.
          </p>

          <div className="overflow-x-auto space-y-4">
            <h3 className="font-mono text-xs font-bold uppercase tracking-wider text-alkota-black">ACTIVE BROWSER STORAGE</h3>
            <table className="w-full text-xs font-mono border-collapse border border-black/10">
              ...
              <tbody>
                <tr className="even:bg-alkota-snow">
                  <td className="p-3 border border-black/10 font-bold">alkota_cookie_consent_v1</td>
                  ...
                  <td className="p-3 border border-black/10 font-bold text-emerald-700">No</td>
                </tr>
                <tr className="even:bg-alkota-snow">
                  <td className="p-3 border border-black/10 font-bold">alkota-region</td>
                  <td className="p-3 border border-black/10">Alkota Cycles</td>
                  <td className="p-3 border border-black/10">Strictly Necessary</td>
                  <td className="p-3 border border-black/10">Stores your requested region preference (UK/US/EU)</td>
                  <td className="p-3 border border-black/10">1 year</td>
                  <td className="p-3 border border-black/10 font-bold text-emerald-700">No</td>
                </tr>
                <tr className="even:bg-alkota-snow">
                  <td className="p-3 border border-black/10 font-bold">sb-auth-token</td>
                  <td className="p-3 border border-black/10">Supabase / Alkota</td>
                  <td className="p-3 border border-black/10">Strictly Necessary</td>
                  <td className="p-3 border border-black/10">Authentication session token for account portals</td>
