...
export const PROJECT_01_BUILD_MATRIX: BuildMatrixItem[] = [
  ...
  },
  {
    ...
    selectableComponentIds: ["fork-fox38-factory"],
    status: "DEVELOPMENT_BASELINE",
    statusText: "DEVELOPMENT BASELINE",
    notes: "FOX 38 Factory 160mm GRIP X2 is baseline. Alternative options under review.",
  },
  {
    systemId: "rear-shock",
    ...
    selectableComponentIds: ["shock-fox-floatx2-factory"],
    status: "DEVELOPMENT_BASELINE",
    statusText: "DEVELOPMENT BASELINE",
    notes: "FOX FLOAT X2 Factory 205x65 Trunnion is baseline.",
  },
  {
