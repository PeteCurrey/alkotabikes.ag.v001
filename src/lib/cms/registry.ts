...
export const CMS_REGISTRY: PageDefinition[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { slotKey: "alpine_image", label: "Haute-Savoie Alpine Test", type: "image", required: true, description: "High altitude trail testing", fallbackAssetPath: "/images/story/prototype-build-validation.jpg" },
  ...
  },
  {
    ...
    label: "Origin Story",
    slots: [
      { slotKey: "hero_image", label: "Story Hero", type: "image", required: true, description: "Alpine field test hero photo", fallbackAssetPath: "/images/story/prototype-build-validation.jpg" },
      ...
      { slotKey: "alpine_test_image", label: "Alpine Test Action", type: "image", required: true, description: "Alpine test action photo", fallbackAssetPath: "/images/story/prototype-build-validation.jpg" },
      { slotKey: "trail_action_image", label: "Trail Action", type: "image", required: true, description: "Trail testing action photo", fallbackAssetPath: "/images/engineering-workshop.jpg" },
    ],
  },
  {
    ...
    slots: [
      ...
      { slotKey: "alpine_image", label: "Alpine Test", type: "image", required: true, description: "Alpine test photo", fallbackAssetPath: "/images/story/prototype-build-validation.jpg" },
  ...
  },
  {
    ...
    slots: [
      ...
      { slotKey: "alpine_image", label: "Alpine Test", type: "image", required: true, description: "Alpine field test photo", fallbackAssetPath: "/images/story/prototype-build-validation.jpg" },
