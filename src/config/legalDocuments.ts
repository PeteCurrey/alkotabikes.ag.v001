...
export const REGIONAL_LEGAL_DOCUMENTS: Record<RegionCode, RegionalLegalDocuments> = {
  uk: {
    ...
    warrantySchedule: {
      id: "ALK-UK-WARSCHED-001",
      title: "Alkota Frame & Component Warranty Schedule (UK)",
      version: "1.0.0-DRAFT",
      effectiveDate: "2026-08-09",
      lastUpdated: "2026-08-09",
      status: "DRAFT",
      approvedBy: null,
      approvedAt: null,
      route: "/warranty#schedule",
      description: "UK frame, swingarm, finish, and hardware coverage terms schedule.",
    },
    privacy: {
  ...
  us: {
    ...
    warrantySchedule: {
      id: "ALK-US-WARSCHED-001",
      title: "Alkota Frame & Component Warranty Schedule (US)",
      version: "1.0.0-DRAFT",
      effectiveDate: "2026-08-09",
      lastUpdated: "2026-08-09",
      status: "DRAFT",
      ...
      approvedAt: null,
      route: "/warranty#schedule",
      description: "US frame, swingarm, finish, and hardware coverage terms schedule under Magnuson-Moss Act.",
      mmwaDesignation: "LIMITED",
    },
    privacy: {
